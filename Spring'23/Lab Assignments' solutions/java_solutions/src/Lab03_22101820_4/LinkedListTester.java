...
public class LinkedListTester {
    public static void main(String[] shelby) {
        ...
        h1.traverseList(); // This should print: 10,20,30,40.
        ...
        h1.traverseList(); // This should print: 10,85,30,40.
